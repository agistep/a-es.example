...
public class SnowflakeIdentifierTest {

    @Test
    public void nextId_shouldGenerateIdWithCorrectBitsFilled() {
        SnowflakeIdentifier snowflake = new SnowflakeIdentifier(784);
    ...
    public void nextId_shouldGenerateUniqueId() {
        SnowflakeIdentifier snowflake = new SnowflakeIdentifier(234);
